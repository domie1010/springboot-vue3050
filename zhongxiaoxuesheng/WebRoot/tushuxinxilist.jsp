...
<form action="tsxxList.do" name="myform" method="post">
...
<table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#ebf0f7">
                          <tr>
                            ...
                            <td bgcolor='#ebf0f7'>图书编号</td>
    <td bgcolor='#ebf0f7'>图书名称</td>
    <td bgcolor='#ebf0f7'>类别</td>
    <td bgcolor='#ebf0f7'>作者</td>
    <td bgcolor='#ebf0f7'>出版社</td>
    ...
    <td>${u.jiage}</td>
                              ...
                              <td align="center"><a href="tsxxDetail.do?id=${u.id}">详细</a></td>
                            </tr>
                          </c:forEach>
                        </table>
<br>
...
<p align="center"> <c:if test="${sessionScope.p==1 }">
		 <c:if test="${page.page>1}">
              <a href="tsxxList.do?page=1" >首页</a>
             <a href="tsxxList.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="tsxxList.do?page=${page.page+1 }">下一页</a>
			<a href="tsxxList.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>
