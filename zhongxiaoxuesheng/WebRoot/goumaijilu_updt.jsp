	...
	<body>
			<form action="updateGoumaijilu.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						...
						<script language="javascript">document.form1.dingdanhao.value='${goumaijilu.dingdanhao}';</script>	<script language="javascript">document.form1.tushubianhao.value='${goumaijilu.tushubianhao}';</script>	<script language="javascript">document.form1.tushumingcheng.value='${goumaijilu.tushumingcheng}';</script>	<script language="javascript">document.form1.leibie.value='${goumaijilu.leibie}';</script>	<script language="javascript">document.form1.zuozhe.value='${goumaijilu.zuozhe}';</script>	<script language="javascript">document.form1.chubanshe.value='${goumaijilu.chubanshe}';</script>	<script language="javascript">document.form1.jiage.value='${goumaijilu.jiage}';</script>	<script language="javascript">document.form1.goumaishuliang.value='${goumaijilu.goumaishuliang}';</script>	<script language="javascript">document.form1.goumaijine.value='${goumaijilu.goumaijine}';</script>	<script language="javascript">document.form1.goumairen.value='${goumaijilu.goumairen}';</script>	
					 </table>
			</form>
   </body>
</html>
