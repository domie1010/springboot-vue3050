	...
	<body>
			<form action="updateKechengxinxi.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						...
						<script language="javascript">document.form1.jieduan.value='${kechengxinxi.jieduan}';</script>	<script language="javascript">document.form1.nianji.value='${kechengxinxi.nianji}';</script>	<script language="javascript">document.form1.kemu.value='${kechengxinxi.kemu}';</script>	<script language="javascript">document.form1.shipinmingcheng.value='${kechengxinxi.shipinmingcheng}';</script>	<script language="javascript">document.form1.xuexishipin.value='${kechengxinxi.xuexishipin}';</script>	<script language="javascript">document.form1.lancishu.value='${kechengxinxi.lancishu}';</script>	
					 </table>
			</form>
   </body>
</html>
