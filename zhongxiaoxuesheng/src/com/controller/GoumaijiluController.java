...
//	分页查询
	...
	public String goumaijiluList(@RequestParam(value="page",required=false)String page,
			ModelMap map,HttpSession session,Goumaijilu goumaijilu, String dingdanhao, String tushubianhao, String tushumingcheng, String leibie, String zuozhe, String chubanshe, String jiage, String goumaishuliang1,String goumaishuliang2, String goumaijine, String goumairen, String issh){
	...
	public String goumaijiluList2(@RequestParam(value="page",required=false)String page,
			ModelMap map,HttpSession session,Goumaijilu goumaijilu, String dingdanhao, String tushubianhao, String tushumingcheng, String leibie, String zuozhe, String chubanshe, String jiage, String goumaishuliang1,String goumaishuliang2, String goumaijine, String goumairen, String issh,HttpServletRequest request){
